...
print("Freq per bin"+str(int(avg_freq)))                   # Careful; if run was cut short/didn't end, len(data_set[i][0]) will be too short
resid = freq-avg_freq
norm_res = resid/np.std(resid)

#----Updating new weights for next round of simulations
old_w = []
